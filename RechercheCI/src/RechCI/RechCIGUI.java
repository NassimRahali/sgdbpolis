...
public class RechCIGUI extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        jMenu1.setText("AlimCB");

        jMenuItem1.setText("Commander les films");
    ...
    {//GEN-HEADEREND:event_bSearchOnCriteriaActionPerformed
        ...
        cursor = collection.find(queryDoc, projectionDoc);
        if(cursor != null)
        {
            this.lbMongo.setBackground(Color.GREEN);
    ...
    {//GEN-HEADEREND:event_tResultsMouseClicked
        if(evt.getClickCount() == 2)
        {
            ...
            projectionDoc.put("release_date", 1);
            projectionDoc.put("genres", 1);
            projectionDoc.put("runtime", 1);
            projectionDoc.put("vote_average", 1);
            projectionDoc.put("vote_count", 1);
            projectionDoc.put("budget", 1);
            projectionDoc.put("certification", 1);
            projectionDoc.put("actors", 1);
            projectionDoc.put("directors", 1);
            projectionDoc.put("spoken_languages", 1);
            projectionDoc.put("homepage", 1);
            projectionDoc.put("original_title", 1);
            projectionDoc.put("overview", 1);
            projectionDoc.put("production_companies", 1);
            projectionDoc.put("production_countries", 1);
            projectionDoc.put("status", 1);
            projectionDoc.put("tagline", 1);
            projectionDoc.put("poster_path", 1);
            DBObject document = collection.findOne(queryDoc, projectionDoc);
    ...
    public void detailDocument(DBObject dbObject)
    {
